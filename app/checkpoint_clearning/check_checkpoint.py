...
# Step 3: Print the state_dict keys
print("\nCheckpoint state_dict keys:")
print(state_dict.keys())

# Step 4: Initialize the model using Hydra configuration
print("\nInitializing the model...")
try:
    with initialize(config_path=CONFIG_PATH, version_base=None, job_name="check_job"):
...
# Step 5: Compare state_dict keys
...
# Step 6: Attempt to load the state_dict
...
# Step 7: Print final model state_dict keys
